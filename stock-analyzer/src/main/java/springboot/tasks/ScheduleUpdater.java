...
public class ScheduleUpdater {
    ...
    public void reportCurrentTime() {
        ...
        Map<String, Map> data = restTemplate.getForObject("https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=AAPL&apikey=S1RP7VOYRC84TD3Z", Map.class);
